...
<details><summary><code>client.pdf_templates.<a href="src/monite/pdf_templates/client.py">preview_by_id</a>(...)</code></summary>
<dl>
<dd>
...
**amount:** `int` — The total amount including taxes
...
**based_on:** `str` — ID of the payable this credit note is based on. The credit note will be linked to this payable
...
**amount:** `typing.Optional[int]` — The total amount including taxes
...
**subtotal:** `typing.Optional[int]` — Subtotal amount before tax in smallest currency unit
...
**tax:** `typing.Optional[int]` — Tax percentage
...
**tax_amount:** `typing.Optional[int]` — Tax amount in smallest currency unit
...
**total:** `typing.Optional[int]` — Total amount including tax in smallest currency unit
...
**subtotal:** `typing.Optional[int]` — Subtotal amount before tax
...
**tax_amount:** `typing.Optional[int]` — Tax amount
...
**total:** `typing.Optional[int]` — Total amount including tax
...
**discount:** `typing.Optional[int]` — The value of the additional discount that will be applied to the total amount. in [minor units](https://docs.monite.com/docs/currencies#minor-units). For example, $12.50 is represented as 1250.
...
**accounting:** `typing.Optional[AccountingSettings]` — Settings for the accounting module.
