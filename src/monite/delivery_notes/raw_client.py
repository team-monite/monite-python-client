...
class RawDeliveryNotesClient:
    ...
    ) -> HttpResponse[DeliveryNoteResourceList]:
        """
    ...
    ) -> HttpResponse[DeliveryNoteResource]:
        """
        Parameters
        ----------
        request : Payload
...
class AsyncRawDeliveryNotesClient:
    ...
    async def get_delivery_notes(
        ...
        *,
        ...
        delivery_date_lte: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[DeliveryNoteResourceList]:
        """
        Get all delivery notes with filtering and pagination.
    ...
    async def post_delivery_notes(
        self, *, request: Payload, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[DeliveryNoteResource]:
        """
        Parameters
        ----------
        request : Payload
