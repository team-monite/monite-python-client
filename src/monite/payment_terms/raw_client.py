...
class RawPaymentTermsClient:
    ...
    def get(self, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[PaymentTermsListResponse]:
        """
        Parameters
        ----------
        ...
        Returns
        -------
        HttpResponse[PaymentTermsListResponse]
            Successful Response
        """
...
class AsyncRawPaymentTermsClient:
    ...
    ) -> AsyncHttpResponse[PaymentTermsListResponse]:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
