...
class RawMailboxesClient:
    ...
    def get(self, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[MailboxDataResponse]:
        """
        ...
        Returns
        -------
        HttpResponse[MailboxDataResponse]
            Successful Response
        """
    ...
    def delete_by_id(
        self, mailbox_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[None]:
        """
        Delete mailbox
...
class AsyncRawMailboxesClient:
    ...
    ) -> AsyncHttpResponse[MailboxDataResponse]:
        """
        Get all mailboxes owned by Entity
