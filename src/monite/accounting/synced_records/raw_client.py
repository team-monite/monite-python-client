...
class RawSyncedRecordsClient:
    ...
    ) -> HttpResponse[SyncRecordResourceList]:
        """
    ...
    ) -> HttpResponse[SyncRecordResource]:
        """
...
class AsyncRawSyncedRecordsClient:
    ...
    async def get(
        ...
        *,
        ...
        updated_at_lte: typing.Optional[dt.datetime] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[SyncRecordResourceList]:
        """
        Get synchronized records
    ...
    async def get_by_id(
        self, synced_record_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[SyncRecordResource]:
        """
        Get synchronized record by id
